...
class CompilerTest {
    ...
    void TestDuplicateIDCompileError(){
        ...
        assertThrows(DuplicateIDCompileError.class, Compiler::compileCodeWithoutPrint);
    }

    @Test
    void TestDivideOrMultiStringException(){
        Compiler.setSourceFile("DivideOrMultiStringException.pvt");
        assertThrows(DivideOrMultiStringException.class, Compiler::compileCodeWithoutPrint);
    }

    @Test
    void TestDifferentTypesComparisonException() {
        Compiler.setSourceFile("DifferentTypesComparisonException.pvt");
        assertThrows(DifferentTypesComparisonException.class, Compiler::compileCodeWithoutPrint);
    }

    @Test
    void TestDeviceHasNoSuchSignalException() {
        Compiler.setSourceFile("DeviceHasNoSuchSignalException.pvt");
        assertThrows(DeviceHasNoSuchSignalException.class, Compiler::compileCodeWithoutPrint);
    }

    @Test
    void TestArgumentWrongTypeException(){
        Compiler.setSourceFile("ArgumentWrongTypeException.pvt");
        assertThrows(ArgumentWrongTypeException.class, Compiler::compileCodeWithoutPrint);
    }
